...
# Setup
# bsData <- readRDS("/mnt/plger/esonder/R/MethQuant/MethQuant/tests/testthat/metScBs.rds")
# bsDataFrame <- readRDS("/mnt/plger/esonder/R/MethQuant/MethQuant/tests/testthat/metDfSmall.rds")
...
bsData <- readRDS("metScBs.rds")
bsDataFrame <- readRDS("metDfSmall.rds")
regions <- GRanges(seqnames="chrSim",
                   ranges=IRanges(start=c(100, 500, 10000),
                                  end=c(200, 600, 12000)))
